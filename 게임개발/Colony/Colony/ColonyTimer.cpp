...
//												Desc											   //
/////////////////////////////////////////////////////////////////////////////////////////////////////
//ColonyTimer Class -> This class is Check Time while OneTick (Basic Timer)						   //
/////////////////////////////////////////////////////////////////////////////////////////////////////
...
void ColonyTimer::Tick(float fLockFPS)
{
	if (m_bStopped)
	{
		m_fTimeElapsed = 0.0f;
...
unsigned long ColonyTimer::GetFrameRate(LPTSTR lpszString, int nCharacters)
{
	if (lpszString)
	{
...
float ColonyTimer::GetTimeElapsed()
{
