...
D3Device::D3Device()
{
	...
	m_nCbvSrvDescriptorIncrementSize = 0;
...
void D3Device::CreateDirect3DDevice()
{
	...
	d3dMsaaQualityLevels.Format = DXGI_FORMAT_R16G16B16A16_UNORM;
...
void D3Device::CreateCommandQueueAndList()
{
	HRESULT hResult;
...
void D3Device::CreateRenderTargetViews()
{
...
void D3Device::CreateDepthStencilView()
{
...
void D3Device::CreateRtvAndDsvDescriptorHeaps()
{
...
void D3Device::ChangeSwapChainState()
{
	WaitForGpuComplete();
...
void D3Device::WaitForGpuComplete()
{
...
void D3Device::CommandListReset()
{
...
void D3Device::CloseCommandAndPushQueue()
{
...
void D3Device::MakeResourceBarrier()
{
...
void D3Device::CloseResourceBarrier()
{
...
void D3Device::SetRtIntoDepthTexture(const D3D12_CPU_DESCRIPTOR_HANDLE& RenderTargetView, const D3D12_CPU_DESCRIPTOR_HANDLE& DepthBufferView)
{
